...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(Clases.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (Clases.diagram.part.ClasesDiagramEditorUtil.openDiagram(view
					.eResource())) {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		Clases.diagram.providers.ClasesValidationProvider.runWithConstraints(
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			Clases.diagram.providers.ClasesMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		Clases.diagram.part.ClasesDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new Clases.diagram.part.ClasesDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = Clases.diagram.part.ClasesDiagramEditorUtil.findView(
	...
	private static void createMarkers(IFile target,
		...
		for (Iterator it = emfValidationStatus.getChildren().iterator(); it
			...
			if (data != null && !data.isEmpty()
				...
				View view = Clases.diagram.part.ClasesDiagramEditorUtil
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		Clases.diagram.providers.ClasesMarkerNavigationProvider.addMarker(
