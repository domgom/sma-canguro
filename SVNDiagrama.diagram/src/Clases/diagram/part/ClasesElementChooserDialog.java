 ...
 * @generated
 */
public class ClasesElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ClasesElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						Clases.diagram.part.Messages.ClasesElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "Clases".equals(fileExtension); //$NON-NLS-1$
	}
