 ...
 * @generated
 */
public class ClaseItemSemanticEditPolicy extends
		Clases.diagram.edit.policies.ClasesBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ClaseItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (Clases.diagram.part.ClasesVisualIDRegistry
					.getVisualID(incomingLink) == Clases.diagram.edit.parts.RelacionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (Clases.diagram.part.ClasesVisualIDRegistry
					.getVisualID(outgoingLink) == Clases.diagram.edit.parts.RelacionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (Clases.diagram.providers.ClasesElementTypes.Relacion_4001 == req
				.getElementType()) {
			return getGEFWrapper(new Clases.diagram.edit.commands.RelacionCreateCommand(
	...
	protected Command getReorientRelationshipCommand(
		...
		case Clases.diagram.edit.parts.RelacionEditPart.VISUAL_ID:
			return getGEFWrapper(new Clases.diagram.edit.commands.RelacionReorientCommand(
					req));
		}
