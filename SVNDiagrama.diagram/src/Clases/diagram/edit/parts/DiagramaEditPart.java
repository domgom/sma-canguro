...
public class DiagramaEditPart extends DiagramEditPart {
	 ...
	 * @generated
	 */
	public final static String MODEL_ID = "Clases"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Clases.diagram.edit.policies.DiagramaItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new Clases.diagram.edit.policies.DiagramaCanonicalEditPolicy());
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new Clases.diagram.edit.commands.ClasesCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
