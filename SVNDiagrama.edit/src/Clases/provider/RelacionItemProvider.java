...
/**
 * This is the item provider adapter for a {@link Clases.Relacion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ClasesPackage.Literals.RELACION__NOMBRE,
         true,
         false,
         false,
  ...
  protected void addDestinoPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relacion_destino_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relacion_destino_feature", "_UI_Relacion_type"),
         ClasesPackage.Literals.RELACION__DESTINO,
         true,
         false,
         true,
         null,
  ...
  protected void addOrigenPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Relacion_origen_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Relacion_origen_feature", "_UI_Relacion_type"),
         ClasesPackage.Literals.RELACION__ORIGEN,
         true,
         false,
         true,
         null,
